...
public class InternationlFragment extends Fragment {
...
//        FirebaseDatabase.getInstance().setPersistenceEnabled(true);
        ...
        databaseReference = firebaseDatabase.getReference().child("News").orderByChild("news_category").equalTo("International");
